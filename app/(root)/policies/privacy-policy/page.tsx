...
const PrivacyPolicyPage = () => {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <p className="text-gray-600 mb-8">Last updated: June 30, 2025</p>

      <div className="prose prose-lg max-w-none">
        <p className="mb-6">
          Vaperoo operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the &quot;Services&quot;). Vaperoo is powered by Vaperoo, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
        </p>
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">Personal Information We Collect or Process</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">Personal Information Sources</h2>
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">How We Use Your Personal Information</h2>
        ...
        <div className="mb-6">
          <h3 className="text-xl font-medium mb-2">Provide, Tailor, and Improve the Services</h3>
          <p className="mb-4">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-medium mb-2">Marketing and Advertising</h3>
          <p className="mb-4">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-medium mb-2">Security and Fraud Prevention</h3>
          <p className="mb-4">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-medium mb-2">Communicating with You</h3>
          <p className="mb-4">
        ...
        <div className="mb-6">
          <h3 className="text-xl font-medium mb-2">Legal Reasons</h3>
          <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">How We Disclose Personal Information</h2>
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">Relationship with Vaperoo</h2>
        <p className="mb-6">
          The Services are hosted by Vaperoo, which collects and processes personal information about your access to and use of the Services in order to provide and improve the Services for you. Information you submit to the Services will be transmitted to and shared with Vaperoo as well as third parties that may be located in countries other than where you reside, in order to provide and improve the Services for you. In addition, to help protect, grow, and improve our business, we use certain Vaperoo enhanced features that incorporate data and information obtained from your interactions with our Store, along with other merchants and with Vaperoo. To provide these enhanced features, Vaperoo may make use of personal information collected about your interactions with our store, along with other merchants, and with Vaperoo. In these circumstances, Vaperoo is responsible for the processing of your personal information, including for responding to your requests to exercise your rights over use of your personal information for these purposes. To learn more about how Vaperoo uses your personal information and any rights you may have, depending on where you live, you may exercise certain rights with respect to your personal information here at <a href="mailto:info@vaperoo.com.au" className="text-blue-600 hover:underline">info@vaperoo.com.au</a>.
        </p>

        <h2 className="text-2xl font-semibold mb-4 mt-8">Third Party Websites and Links</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">Children&apos;s Data</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">Security and Retention of Your Information</h2>
        <p className="mb-6">
        ...
        <div className="space-y-4 mb-6">
          <div>
            <h3 className="text-lg font-medium mb-2">Right to Access / Know</h3>
            <p>You may have a right to request access to personal information that we hold about you.</p>
          </div>
          <div>
            <h3 className="text-lg font-medium mb-2">Right to Delete</h3>
            <p>You may have a right to request that we delete personal information we maintain about you.</p>
          </div>
          <div>
            <h3 className="text-lg font-medium mb-2">Right to Correct</h3>
            <p>You may have a right to request that we correct inaccurate personal information we maintain about you.</p>
          </div>
          <div>
            <h3 className="text-lg font-medium mb-2">Right of Portability</h3>
            <p>You may have a right to receive a copy of the personal information we hold about you and to request that we transfer it to a third party, in certain circumstances and with certain exceptions.</p>
          </div>
          <div>
            <h3 className="text-lg font-medium mb-2">Managing Communication Preferences</h3>
            <p>We may send you promotional emails, and you may opt out of receiving these at any time by using the unsubscribe option displayed in our emails to you. If you opt out, we may still send you non-promotional emails, such as those about your account or orders that you have made.</p>
          </div>
        </div>

        <p className="mb-6">
          You may exercise any of these rights where indicated on the Services or by contacting us using the contact details provided below. To learn more about how Vaperoo uses your personal information and any rights you may have, including rights related to data processed by Vaperoo, you can visit https://privacy.shopify.com/en.
        </p>
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">Complaints</h2>
        <p className="mb-6">
        ...
        <p className="mb-6">
          Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:info@vaperoo.com.au" className="text-blue-600 hover:underline">info@vaperoo.com.au</a>
        </p>
      </div>
    </div>
  )
